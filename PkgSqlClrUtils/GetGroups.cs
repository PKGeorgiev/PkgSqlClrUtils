...
public partial class UserDefinedFunctions
{
    [Microsoft.SqlServer.Server.SqlFunction(
        ...
        FillRowMethodName = "GetGroupsFiller",
        TableDefinition = @"
    ...
    public static IEnumerable GetGroups(String ldapFilter = "", String attributes = "", String searchBase = "", String domainController = "")
    {
        return Common.CallImpersonated<IEnumerable>(
            () =>
            {
                ...
                List<SearchResult> items = PkgLdapUtils.PkgLdap.GetGroups(ldapFilter, attributes, searchBase, dc);
    ...
    public static void GetGroupsFiller(
        object config,
        out Guid objectGuid,
